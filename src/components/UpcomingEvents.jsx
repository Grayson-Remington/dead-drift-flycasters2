...
function UpcomingEvents() {
	return (
		<div className='flex flex-col item-center pt-[72px] h-full'>
			<iframe
			...
			></iframe>
			<img
				className='self-center w-full max-w-2xl h-full p-10 '
				src='public/assets/high-desert-challenge.jpg'
				alt=''
			/>
			<img
				className='self-center w-full max-w-2xl h-full p-10 '
				src='public/assets/border-wars.jpg'
				alt=''
			/>
